...
VCS = SW_VCS=2017.12-SP2-1 vcs -sverilog +vc -Mupdate -line -full64 +define+CLOCK_PERIOD=$(CLOCK_PERIOD) +define+PIPELINE +lint=PCWM +lint=TFIPC-L +lint=ERASM-L +define+DEBUG +error+20
